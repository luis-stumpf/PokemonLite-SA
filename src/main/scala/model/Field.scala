...
def printPlayer1 (width: Int, name: String): String = "|"+" "*calcStart(width, 0.85, name) + name + " " * calcEnd(width, 0.15) + "|" + " " * width + "|\n"
def printPlayer2 (width: Int, name: String): String = "|"+" "*calcEnd(width, 0.15) + name + " " * calcStart(width, 0.85, name)+ "|" + " " * width + "|\n"
...
def calcStart(width: Int, start: Double, element: T): Int = (width * start).floor.toInt - element.toString.length
def calcEnd(width: Int, start: Double): Int = (width * start).floor.toInt