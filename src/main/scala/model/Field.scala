...
case class Field(width: Int, nP1: String, nP2: String):
  def mesh (width : Int = 50, height : Int = 3, nP1 : String = "", nP2 : String = ""): String = row(width) + printPlayer1(width, nP1) + printPokemonP1(width, Pokemon("Glurak", 150)) + col(width, height) + printPokemonP2(width, Pokemon("Simsala", 200)) + printPlayer2(width, nP2) + row(width)
